# -*- coding: utf-8 -*-
"""Multimodal RecommendationBot.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1cvTz2hnxd0Af1k2yNTd-0abuWsj2KnWn
...
output, image_url, img_path = multimodal_retrivial('recommend a blue shirt for office')
print(type(output))
print('--')
print(output)
print('**')
